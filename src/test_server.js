...
app.get('/api/doctor/records/:patientId', (req, res) => {
  res.status(200).json({
    success: true,
    records: [
      {
...
app.listen(port, () => {
  ...
  console.log(
    'Note: This is a test server with mock endpoints. For full functionality, run index.js with a connected Ethereum node.'
  )
})
