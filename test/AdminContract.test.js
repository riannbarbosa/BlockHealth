...
contract('AdminContract', accounts => {
  ...
  describe('Doctor Management', () => {
    it('should register a doctor successfully', async () => {
      const tx = await adminInstance.registerDoctor(doctor1, 'Dr. John Smith', 'Cardiology', 'LIC123456', {
        from: owner,
      })
    ...
    it('should not allow non-owner to register a doctor', async () => {
      try {
        await adminInstance.registerDoctor(doctor1, 'Dr. Test', 'Cardiology', 'LIC123', { from: unauthorized })
  ...
  describe('Patient Management', () => {
    ...
    it('should not allow non-owner to register a patient', async () => {
      try {
        await adminInstance.registerPatient(patient1, 'Alice', '1990-01-01', '1234567890', 'Bob', {
          from: unauthorized,
        })
        assert.fail('Should have thrown an error')
      } catch (error) {
