...
contract('PatientContract', accounts => {
  ...
  beforeEach(async () => {
    ...
    patientInstance = await PatientContract.new(medicInstance.address, adminInstance.address, { from: owner })
  ...
  describe('Profile Management', () => {
    it('should update patient profile', async () => {
      const tx = await patientInstance.updateProfile('Alice Johnson', 'alice@email.com', '1234567890', {
        from: patient1,
      })
